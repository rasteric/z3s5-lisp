...
Windows: This has not been tested on Windows but should work as long as your machine satisfies the compilation requirements for the [Beep](https://github.com/faiface/beep) sound library or if you use build tag `nosound`.
