...
footer-left: Version 2.3.3+c903e1b
...
For Z3S5 Lisp Version 2.3.3+c903e1b with installed modules (tasks help beep fileio decimal ling float console base).
...
See also: [`equal?`](#link657175616c3f).	 [→index](#idx) [→topic](#equality)
...
**Warning: Deprecated.** [→topic](#equality)
...
See also: [`dump`](#link64756d70), [`dump-bindings`](#link64756d702d62696e64696e6773), [`find-missing-help-entries`](#link66696e642d6d697373696e672d68656c702d656e7472696573).	 [→index](#idx) [→topic](#system)
