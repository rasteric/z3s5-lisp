...
footer-left: Version 2.4.2+30c3151-gui.fyne2
author: by Erich Rast and all Help system contributors
date: 2024-7-15 13:26
header-includes: |
    \lstset{% for listings
...
For Z3S5 Lisp Version 2.4.2+30c3151-gui.fyne2 with installed modules (gui-fileio gui fyne2 oop lib kvdb zimage tasks help beep unicode db fileio decimal ling float console base).
