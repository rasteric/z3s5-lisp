...
footer-left: Version 2.3.10+4169fc6
...
For Z3S5 Lisp Version 2.3.10+4169fc6 with installed modules (oop lib kvdb zimage tasks help beep db fileio decimal ling float console base).
