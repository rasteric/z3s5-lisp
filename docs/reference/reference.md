...
footer-left: Version 2.3.9+b7273e2
...
For Z3S5 Lisp Version 2.3.9+b7273e2 with installed modules (oop lib kvdb zimage tasks help beep db fileio decimal ling float console base).
...
## `type-of` : procedure/1 {#link747970652d6f66}
