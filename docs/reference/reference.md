...
footer-left: Version 2.4+6ce7d88-gui.fyne2
author: by Erich Rast and all Help system contributors
date: 2023-12-22 10:32
header-includes: |
    \lstset{% for listings
...
For Z3S5 Lisp Version 2.4+6ce7d88-gui.fyne2 with installed modules (gui fyne2 oop lib kvdb zimage tasks help beep unicode db fileio decimal ling float console base).
