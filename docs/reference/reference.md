...
footer-left: Version 2.3.9+ad9c251
...
For Z3S5 Lisp Version 2.3.9+ad9c251 with installed modules (oop lib kvdb zimage tasks help beep db fileio decimal ling float console base).
