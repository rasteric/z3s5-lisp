...
footer-left: Version 2.3.11+d3bbf5d
...
For Z3S5 Lisp Version 2.3.11+d3bbf5d with installed modules (oop lib kvdb zimage tasks help beep db fileio decimal ling float console base).
