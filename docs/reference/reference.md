...
footer-left: Version 2.4+80f8243-gui.fyne2
...
For Z3S5 Lisp Version 2.4+80f8243-gui.fyne2 with installed modules (gui fyne2 oop lib kvdb zimage tasks help beep unicode db fileio decimal ling float console base).
...
## `set-zedit-show-line-numbers` : procedure/2 {#link7365742d7a656469742d73686f772d6c696e652d6e756d62657273}

Usage: `(set-zedit-show-line-numbers zedit show?)`

Enable the line number display if `show?` is true, disable it otherwise.

See also: [`new-zedit`](#link6e65772d7a65646974), [`zedit-show-line-numbers?`](#link7a656469742d73686f772d6c696e652d6e756d626572733f).	 [→index](#idx)
...
## `zedit-show-line-numbers?` : procedure/1 {#link7a656469742d73686f772d6c696e652d6e756d626572733f}

Usage: `(zedit-show-line-numbers? zedit) => bool`

Return true if the given zedit editor displays line numbers, nil otherwise.

See also: [`new-zedit`](#link6e65772d7a65646974), [`set-zedit-show-line-numbers`](#link7365742d7a656469742d73686f772d6c696e652d6e756d62657273).	 [→index](#idx)

## `zedit-show-whitespace?` : procedure/1 {#link7a656469742d73686f772d776869746573706163653f}

Usage: `(zedit-show-whitespace? zedit) => bool`

Return true if the given zedit editor displays white space characters as special glyphs, nil otherwise.

See also: [`new-zedit`](#link6e65772d7a65646974).	 [→index](#idx)
