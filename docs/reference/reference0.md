...
footer-left: Version 2.3.11+bf6ccbf
...
For Z3S5 Lisp Version 2.3.11+bf6ccbf with installed modules (oop lib kvdb zimage tasks help beep db fileio decimal ling float console base).
