...
footer-left: Version 2.4.2+c8b8ac2-gui.fyne2
...
For Z3S5 Lisp Version 2.4.2+c8b8ac2-gui.fyne2 with installed modules (gui-fileio gui fyne2 oop lib kvdb zimage tasks help beep unicode db fileio decimal ling float console base).
