...
footer-left: Version 2.3.5+ea089bc
...
For Z3S5 Lisp Version 2.3.5+ea089bc with installed modules (kvdb zimage tasks help beep db fileio decimal ling float console base).
