...
footer-left: Version 2.3.10+e1d53f4
...
For Z3S5 Lisp Version 2.3.10+e1d53f4 with installed modules (action action oop lib kvdb zimage tasks help beep db fileio decimal ling float console base).
