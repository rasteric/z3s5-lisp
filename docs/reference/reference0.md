...
footer-left: Version 2.3.10+db5552f
...
For Z3S5 Lisp Version 2.3.10+db5552f with installed modules (action action oop lib kvdb zimage tasks help beep db fileio decimal ling float console base).
