...
footer-left: Version 2.3.7+9fe4ff9
...
For Z3S5 Lisp Version 2.3.7+9fe4ff9 with installed modules (kvdb zimage tasks help beep db fileio decimal ling float console base).
