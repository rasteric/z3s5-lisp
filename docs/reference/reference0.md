...
footer-left: Version 2.4.2+e3a1f1e-gui.fyne2
author: by Erich Rast and all Help system contributors
date: 2024-5-28 12:40
header-includes: |
    \lstset{% for listings
...
For Z3S5 Lisp Version 2.4.2+e3a1f1e-gui.fyne2 with installed modules (gui-fileio gui fyne2 oop lib kvdb zimage tasks help beep unicode db fileio decimal ling float console base).
